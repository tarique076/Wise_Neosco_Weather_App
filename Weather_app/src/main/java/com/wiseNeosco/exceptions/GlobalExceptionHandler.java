package com.wiseNeosco.exceptions;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> weatherExceptionHandler(WeatherException e, WebRequest re){
	...
	public ResponseEntity<ErrorDetails> forecastExceptionHandler(ForecastException e, WebRequest re){
		ErrorDetails err = new ErrorDetails(LocalDateTime.now(), e.getMessage(), re.getDescription(false));
